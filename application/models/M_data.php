...
class M_data extends CI_Model {
    ...
    {
      $data = $this->db->query("SELECT a.id_zakat_maal, a.nama_pemberi_zakat, a.kategori_zakat, a.nominal_zakat, a.alamat, a.tanggal, a.petugas1, a.petugas2, b.id_koor, b.nama_koor, b.alamat_koor FROM tbl_zakat_maal AS a LEFT JOIN tbl_koordinator AS b ON a.petugas2 = b.id_koor order by id_zakat_maal DESC");
      return $data;
    }
