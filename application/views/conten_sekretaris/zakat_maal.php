              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <!-- <a class="btn btn-app" href="<?php echo base_url('sekretaris/Laporan/cetak_laporan_zakat_maal') ?>">
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td><?php echo $x++; ?></td>
                          <td><a href="<?php echo base_url('sekretaris/maal/print_kwitansi/'.$row->id_zakat_maal) ?>"><button class="btn btn-primary"><?php echo $row->nama_pemberi_zakat; ?></button></a></td>
                          <td><center>
                            <?php 
                          ...
                          <td width="12%">
                            ...
                            <a href="<?php echo base_url('sekretaris/Maal/hapus_data/'.$row->id_zakat_maal) ?>"><button type="button" class="btn btn-danger" onclick="hapus()"><i class="fa fa-trash"></i></button></a>
                          </td>
                        </tr>
                        <?php } ?>
                      </tbody>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-bg">
    <div class="modal-content">
      <form method="post" name="zakat_fitrah" action="<?php echo base_url('sekretaris/Maal/tambah_data_zakat_maal') ?>">
...
<div class="modal fade" id="myModalEdit<?php echo $y++ ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-bg">
    <div class="modal-content">
      <form method="post" name="zakat_fitrah" action="<?php echo base_url('sekretaris/Maal/update_data_maal/').$row->id_zakat_maal ?>">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">×</span>
        </button>
