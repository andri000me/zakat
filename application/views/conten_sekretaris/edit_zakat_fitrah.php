            ...
            <div class="row">
              <div class="col-md-6 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <form method="post" action="<?php echo base_url('sekretaris/Fitrah/update_data/'.$id) ?>" name="zakat_fitrah">
			        ...
			        <input type="text" class="form-control" name="beras" readonly="yes" onfocus="jumlah_zakat()" value="<?php echo $beras ?>" />
