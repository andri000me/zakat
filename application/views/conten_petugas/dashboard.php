            ...
            <div class="row top_tiles">
              ...
              <div class="animated flipInY col-lg-6 col-md-3 col-sm-6 col-xs-12">
                <div class="tile-stats">
                  ...
                  <h3>Jumlah Pemberi Zakat Fitrah</h3>
                  <p>Jumlah Pemberi Fitrah Sampai saat ini</p>
                </div>
              </div>
              <div class="animated flipInY col-lg-6 col-md-3 col-sm-6 col-xs-12">
                <div class="tile-stats">
                  ...
                  <h3>Jumlah Pemberi Zakat Maal</h3>
                  <p>Jumlah Pemberi Zakat Maal Sampai saat ini</p>
                </div>
              </div>
