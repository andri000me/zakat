                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="12%">
                            ...
                            <a href="<?php echo base_url('petugas/Maal/hapus_data/'.$row->id_zakat_maal) ?>"><button type="button" class="btn btn-danger" onclick="hapus()"><i class="fa fa-trash"></i></button></a>
                          </td>
                        </tr>
                        <?php } ?>
                      </tbody>
