      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            <!-- <a class="btn btn-app" href="<?php echo base_url('petugas/Laporan/cetak_laporan_zakat_fitrah') ?>">
              ...
              <tbody>
                ...
                foreach ($fitrah->result() as $row) { ?>
                  <tr>
                    ...
                    <td width="12%">
                      <a href="<?php echo base_url('petugas/Fitrah/vedit/' . $row->id_zakat_fitrah) ?>"><button type="button" class="btn btn-warning"><i class="fa fa-edit"></i></button></a>
                      <a class="hapus-fitrah" href="<?php echo base_url('petugas/Fitrah/hapus_data/' . $row->id_zakat_fitrah) ?>"><button type="button" class="btn btn-danger"><i class="fa fa-trash"></i></button></a>
                    </td>
                  </tr>
                <?php } ?>
              </tbody>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-bg">
    <div class="modal-content">
      <form method="post" name="zakat_fitrah" action="<?php echo base_url('petugas/Fitrah/tambah_data_zakat_fitrah') ?>">
        ...
        <div class="modal-body">
          ...
          <input type="number" class="form-control" name="jiwa" required />
