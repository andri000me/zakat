...
<table width="905" height="auto">
  <tr>
    <td width="263"><div align="center"><img src="<?php echo base_url('./assets/lokasi/'.$foto) ?>" width="171" height="149" /></div></td>
  ...
  <br />
  <span class="style4">TAHUN <?php echo $M-579; ?> H / <?php echo $M; ?> M</span> </td>
  </tr>
  <tr>
    <td colspan="2">
...
foreach ($cetak_laporan_fitrah->result() as $row) { ?>
  ...
  <tr>
    ...
    echo number_format($jadi,2) ?></strong></td>
...
<br><br>
    <table width="905">
      <tr>
        <td><div align="right">Janti, <?php echo date('d F Y'); ?></div></td>
      </tr>
      <tr>
        <td><div align="right"><?php echo $jabatan; ?> </div></td>
      </tr>
      <tr>
      ...
      <tr>
        <td><div align="right"><strong>(<?php echo $nama ?>)</strong></div></td>
      </tr>
    </table>
</body>
</html>
