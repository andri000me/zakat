            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                  <a href="<?php echo base_url('admin/Laporan/cetak_laporan_zakat_fitrah') ?>">
                ...
                <a href="<?php echo base_url('admin/Laporan/cetak_laporan_zakat_maal') ?>">
	              <div class="animated flipInY col-lg-6 col-md-3 col-sm-6 col-xs-12">
	                <div class="tile-stats">
              ...
              <form method="post" action="<?php echo base_url('admin/Laporan/laporan_penerima_zakat') ?>">
