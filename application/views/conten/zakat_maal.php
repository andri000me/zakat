                ...
                foreach ($maal->result() as $row) { ?>
                  <tr>
                    ...
                    <td width="12%">
                      ...
                      <a class="btn btn-danger hapus-maal" title="Hapus Data Zakat Maal" href="<?php echo base_url('admin/Maal/hapus_data/' . $row->id_zakat_maal) ?>"><i class="fa fa-trash"></i></button></a>
                    </td>
                  </tr>
                <?php } ?>
              </tbody>
