                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <table class="table table-bordered">
                            ...
                            <form method="post" action="<?= base_url('admin/perhitungan/tambah_alt_ghorim') ?>">
                                <tbody>
                                    ...
                                    <tr>
                                        <td>Fakir</td>
                                        <td>
                                            <input type="number" class="form-control" id="C33" name="G11" readonly value="1">
                                        </td>
                                        <td>
                                            <select class="form-control" id="C34" name="G12">
                                        ...
                                        <td>
                                            <select class="form-control" id="C35" name="G13">
                                                <option value="">0</option>
                                                <?php
                                                foreach ($bobot->result() as $row) { ?>
                                                    <option value="<?= $row->nominal_bobot ?>"><?= $row->nominal_bobot ?></option>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number" class="form-control" id="C44" name="G22" readonly value="1">
                                        </td>
                                        <td>
                                            <select class="form-control" id="C45" name="G23">
                                                <option value="">0</option>
                                                <?php
                                                foreach ($bobot->result() as $row) { ?>
                                                    <option value="<?= $row->nominal_bobot ?>"><?= $row->nominal_bobot ?></option>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number" class="form-control" id="C54" name="G32" readonly value="0">
                                        </td>
                                        <td>
